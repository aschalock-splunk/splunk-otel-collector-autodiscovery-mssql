		...
		mssql_containers, []testutils.CollectorBuilder{
			...
			func(collector testutils.Collector) testutils.Collector {
				return collector.WithEnv(map[string]string{
					...
					"--discovery",
					"--set", "splunk.discovery.receivers.smartagent/telegraf/sqlserver.config.endpoint=localhost:1433",
					...
					"--set", "splunk.discovery.receivers.smartagent/telegraf/sqlserver.config.clusterName=TestCluster",
