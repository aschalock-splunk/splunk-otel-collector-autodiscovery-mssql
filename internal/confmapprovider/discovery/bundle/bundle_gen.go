...
//go:generate discoverybundler -r -c -d ../../../../cmd/otelcol/config/collector/config.d.linux/receivers -t bundle.d/receivers/smartagent-telegraf-sqlserver.discovery.yaml.tmpl
//go:generate discoverybundler -r -t bundle.d/receivers/smartagent-telegraf-sqlserver.discovery.yaml.tmpl
